        ...
        <footer className="w-full border-t border-outline-variant/30 bg-surface">
            <div className="max-w-7xl mx-auto px-8 py-12 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <a className="text-on-surface-variant hover:text-primary transition-colors opacity-80 hover:opacity-100" href="mailto:kcsuan424@gmail.com" target="_blank">Email</a>
                </div>
            </div>
        </footer>
    );
